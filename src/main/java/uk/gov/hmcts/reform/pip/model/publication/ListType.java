...
public enum ListType {
    ...
    UT_IAC_JR_CARDIFF_DAILY_HEARING_LIST(NATIONAL, List.of(CFT_IDAM), ALL_VERIFIED_THIRD_PARTY_CFT_ROLES,
         ...
         "Upper Tribunal (Immigration and Asylum) Chamber - "
                                            + "Judicial Review: Bristol and Cardiff Daily Hearing List"),
    ...
    MENTAL_HEALTH_TRIBUNAL_HEARING_LIST(NATIONAL, List.of(PI_AAD), ALL_VERIFIED_THIRD_PARTY_PRESS_ROLES,
                                        null, "Mental Health Tribunal Daily Hearing List",
    ...
    BUSINESS_AND_PROPERTY_DIVISION_ROLLS_BUILDING_DAILY_CAUSE_LIST(NATIONAL, List.of(CFT_IDAM),
                                  ...
                                  null, "Business & Property Division Rolls Building Daily Cause List",
                                   true, false, false, false),;
