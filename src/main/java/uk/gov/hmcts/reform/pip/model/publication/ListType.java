...
public enum ListType {
    ...
    BIRMINGHAM_ADMINISTRATIVE_COURT_DAILY_CAUSE_LIST(NATIONAL, List.of(CFT_IDAM), ALL_VERIFIED_THIRD_PARTY_CFT_ROLES,
                                                     null, "Birmingham Administrative Court Daily Cause List",
                                                     true, false, false, false),
    BRISTOL_AND_CARDIFF_ADMINISTRATIVE_COURT_DAILY_CAUSE_LIST(
        NATIONAL, List.of(CFT_IDAM), ALL_VERIFIED_THIRD_PARTY_CFT_ROLES,
        BIRMINGHAM_ADMINISTRATIVE_COURT_DAILY_CAUSE_LIST,
        "Bristol and Cardiff Administrative Court Daily Cause List", true, false, false, false),
    ...
    LEEDS_ADMINISTRATIVE_COURT_DAILY_CAUSE_LIST(NATIONAL, List.of(CFT_IDAM), ALL_VERIFIED_THIRD_PARTY_CFT_ROLES,
                                                null, "Leeds Administrative Court Daily Cause List",
                                                true, false, false, false),
