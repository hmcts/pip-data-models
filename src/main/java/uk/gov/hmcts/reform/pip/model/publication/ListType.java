...
public enum ListType {
    ...
    INTERIM_APPLICATIONS_CHD_DAILY_CAUSE_LIST(NATIONAL, List.of(CFT_IDAM), ALL_VERIFIED_THIRD_PARTY_CFT_ROLES, null,
                  "Interim Applications List (ChD) Daily Cause List", true, false, false, false),
    ...
    BUSINESS_AND_PROPERTY_DAILY_CAUSE_LIST(NATIONAL, List.of(CFT_IDAM), ALL_VERIFIED_THIRD_PARTY_CFT_ROLES, null,
                                  "Business & Property Daily Cause List", true, false, false, false),
