...
public enum ListType {
    ...
    MAGISTRATES_PUBLIC_ADULT_COURT_LIST_FUTURE(VENUE, CRIME_IDAM,
        ALL_VERIFIED_THIRD_PARTY_CRIME_ROLES, MAGISTRATES_PUBLIC_ADULT_COURT_LIST_DAILY,"Magistrates Public Adult Court List - Future");
