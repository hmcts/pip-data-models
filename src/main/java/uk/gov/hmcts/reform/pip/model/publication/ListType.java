...
public enum ListType {
    ...
    PROPERTY_TRUSTS_PROBATE_LIST_CHD_DAILY_CAUSE_LIST(NATIONAL, CFT_IDAM, ALL_VERIFIED_THIRD_PARTY_CFT_ROLES,
                                                      "Property, Trusts and Probate List (ChD) Daily Cause List"),
    REVENUE_LIST_CHD_DAILY_CAUSE_LIST(NATIONAL, CFT_IDAM, ALL_VERIFIED_THIRD_PARTY_CFT_ROLES,
                                      "Revenue List (ChD) Daily Cause List"),
    TECHNOLOGY_AND_CONSTRUCTION_COURT_KB_DAILY_CAUSE_LIST(NATIONAL, CFT_IDAM, ALL_VERIFIED_THIRD_PARTY_CFT_ROLES,
    ...
    COMPETITION_LIST_CHD_DAILY_CAUSE_LIST(
        NATIONAL, CFT_IDAM, ALL_VERIFIED_THIRD_PARTY_CFT_ROLES, "Competition List (ChD) Daily Cause List"),
    ...
    CROWN_DAILY_PDDA_LIST(VENUE, CRIME_IDAM, ALL_VERIFIED_THIRD_PARTY_CRIME_ROLES, "Crown Daily List"),
    CROWN_FIRM_PDDA_LIST(VENUE, CRIME_IDAM, ALL_VERIFIED_THIRD_PARTY_CRIME_ROLES, "Crown Firm List"),
    CROWN_WARNED_PDDA_LIST(VENUE, CRIME_IDAM, ALL_VERIFIED_THIRD_PARTY_CRIME_ROLES, "Crown Warned List");
