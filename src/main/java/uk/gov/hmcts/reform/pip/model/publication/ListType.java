...
public enum ListType {
    ...
    FAMILY_DAILY_CAUSE_LIST(VENUE, List.of(CFT_IDAM), ALL_VERIFIED_THIRD_PARTY_CFT_ROLES, null,
                            "Family Daily Cause List", true, false, false, false),
    CIVIL_AND_FAMILY_DAILY_CAUSE_LIST(VENUE, List.of(CFT_IDAM), ALL_VERIFIED_THIRD_PARTY_CFT_ROLES, null,
                                      "Civil and Family Daily Cause List", true, false, false, false),
    COP_DAILY_CAUSE_LIST(VENUE, List.of(CFT_IDAM), ALL_VERIFIED_THIRD_PARTY_CFT_ROLES),
    ET_FORTNIGHTLY_PRESS_LIST(OWNING_HEARING_LOCATION, List.of(CFT_IDAM), ALL_VERIFIED_THIRD_PARTY_CFT_ROLES),
    ET_DAILY_LIST(OWNING_HEARING_LOCATION, List.of(CFT_IDAM), ALL_VERIFIED_THIRD_PARTY_CFT_ROLES),
    SSCS_DAILY_LIST(OWNING_HEARING_LOCATION, List.of(CFT_IDAM), ALL_VERIFIED_THIRD_PARTY_CFT_ROLES),
    SSCS_DAILY_LIST_ADDITIONAL_HEARINGS(OWNING_HEARING_LOCATION, List.of(CFT_IDAM), ALL_VERIFIED_THIRD_PARTY_CFT_ROLES,
    ...
    CARE_STANDARDS_LIST(NATIONAL, List.of(CFT_IDAM), ALL_VERIFIED_THIRD_PARTY_CFT_ROLES, null,
                        "Care Standards Tribunal Weekly Hearing List", true, false,
                        false, false),
    PRIMARY_HEALTH_LIST(NATIONAL, List.of(CFT_IDAM), ALL_VERIFIED_THIRD_PARTY_CFT_ROLES, null,
                        "Primary Health Tribunal Weekly Hearing List", true, false,
                        false, false),
    ...
    UT_IAC_JR_LONDON_DAILY_HEARING_LIST(NATIONAL, List.of(CFT_IDAM), ALL_VERIFIED_THIRD_PARTY_CFT_ROLES, null,
        "Upper Tribunal (Immigration and Asylum) Chamber - Judicial Review: London Daily Hearing List",
                                        true, false, false, false),
    UT_IAC_JR_LEEDS_DAILY_HEARING_LIST(NATIONAL, List.of(CFT_IDAM), ALL_VERIFIED_THIRD_PARTY_CFT_ROLES, null,
    ...
    UT_IAC_JR_CARDIFF_DAILY_HEARING_LIST(NATIONAL, List.of(CFT_IDAM), ALL_VERIFIED_THIRD_PARTY_CFT_ROLES,
        ...
        "Upper Tribunal (Immigration and Asylum) Chamber - Judicial Review: Bristol and Cardiff Daily Hearing List",
                                         true, false, false, false),
    UT_IAC_STATUTORY_APPEALS_DAILY_HEARING_LIST(NATIONAL, List.of(CFT_IDAM), ALL_VERIFIED_THIRD_PARTY_CFT_ROLES, null,
        "Upper Tribunal (Immigration and Asylum) Chamber - Statutory Appeal: Daily hearing list",
                                                true, false, false, false),
    SIAC_WEEKLY_HEARING_LIST(NATIONAL, List.of(CFT_IDAM), ALL_VERIFIED_THIRD_PARTY_CFT_ROLES, null,
                             "Special Immigration Appeals Commission Weekly Hearing List",
                             true, false, false, false),
    POAC_WEEKLY_HEARING_LIST(NATIONAL, List.of(CFT_IDAM), ALL_VERIFIED_THIRD_PARTY_CFT_ROLES,
                             SIAC_WEEKLY_HEARING_LIST,
                             "Proscribed Organisations Appeal Commission Weekly Hearing List",
                             true, false, false, false),
    PAAC_WEEKLY_HEARING_LIST(NATIONAL, List.of(CFT_IDAM), ALL_VERIFIED_THIRD_PARTY_CFT_ROLES,
                             SIAC_WEEKLY_HEARING_LIST,
                             "Pathogens Access Appeal Commission Weekly Hearing List",
                             true, false, false, false),
    FTT_TAX_WEEKLY_HEARING_LIST(NATIONAL, List.of(CFT_IDAM), ALL_VERIFIED_THIRD_PARTY_CFT_ROLES),
    FTT_LR_WEEKLY_HEARING_LIST(NATIONAL, List.of(CFT_IDAM), ALL_VERIFIED_THIRD_PARTY_CFT_ROLES),
    UT_T_AND_CC_DAILY_HEARING_LIST(NATIONAL, List.of(CFT_IDAM), ALL_VERIFIED_THIRD_PARTY_CFT_ROLES, null,
                                   "Upper Tribunal (Tax and Chancery Chamber) Daily hearing list",
                                   true, false, false, false),
    UT_LC_DAILY_HEARING_LIST(NATIONAL, List.of(CFT_IDAM), ALL_VERIFIED_THIRD_PARTY_CFT_ROLES, null,
    ...
    SSCS_SOUTH_EAST_DAILY_HEARING_LIST(NATIONAL, List.of(CFT_IDAM), ALL_VERIFIED_THIRD_PARTY_CFT_ROLES,
    ...
    SSCS_NORTH_EAST_DAILY_HEARING_LIST(NATIONAL, List.of(CFT_IDAM), ALL_VERIFIED_THIRD_PARTY_CFT_ROLES,
        SSCS_MIDLANDS_DAILY_HEARING_LIST,
        "North East Social Security and Child Support Tribunal Daily Hearing List"),
    SSCS_NORTH_WEST_DAILY_HEARING_LIST(NATIONAL, List.of(CFT_IDAM), ALL_VERIFIED_THIRD_PARTY_CFT_ROLES,
        SSCS_MIDLANDS_DAILY_HEARING_LIST,
        "North West Social Security and Child Support Tribunal Daily Hearing List"),
    SSCS_LONDON_DAILY_HEARING_LIST(NATIONAL, List.of(CFT_IDAM), ALL_VERIFIED_THIRD_PARTY_CFT_ROLES,
        SSCS_MIDLANDS_DAILY_HEARING_LIST,
    ...
    COUNTY_COURT_LONDON_CIVIL_DAILY_CAUSE_LIST(NATIONAL, List.of(CFT_IDAM), ALL_VERIFIED_THIRD_PARTY_CFT_ROLES,
                                               null, "County Court at Central London Civil Daily Cause List",
                                               true, false, false, false),
    CIVIL_COURTS_RCJ_DAILY_CAUSE_LIST(NATIONAL, List.of(CFT_IDAM), ALL_VERIFIED_THIRD_PARTY_CFT_ROLES, null,
                                     "Civil Courts at the RCJ Daily Cause List", true, false, false, false),
    COURT_OF_APPEAL_CRIMINAL_DAILY_CAUSE_LIST(NATIONAL, List.of(CRIME_IDAM), ALL_VERIFIED_THIRD_PARTY_CRIME_ROLES, null,
                                              "Court of Appeal (Criminal Division) Daily Cause List",
                                              true, false, false, false),
    FAMILY_DIVISION_HIGH_COURT_DAILY_CAUSE_LIST(NATIONAL, List.of(CFT_IDAM), ALL_VERIFIED_THIRD_PARTY_CFT_ROLES, null,
                                                "Family Division of the High Court Daily Cause List",
                                                true, false, false, false),
    KINGS_BENCH_DIVISION_DAILY_CAUSE_LIST(NATIONAL, List.of(CFT_IDAM), ALL_VERIFIED_THIRD_PARTY_CFT_ROLES, null,
                                          "King’s Bench Division Daily Cause List", true, false, false, false),
    KINGS_BENCH_MASTERS_DAILY_CAUSE_LIST(NATIONAL, List.of(CFT_IDAM), ALL_VERIFIED_THIRD_PARTY_CFT_ROLES, null,
                                         "King’s Bench Masters Daily Cause List", true, false, false, false),
    SENIOR_COURTS_COSTS_OFFICE_DAILY_CAUSE_LIST(NATIONAL, List.of(CFT_IDAM), ALL_VERIFIED_THIRD_PARTY_CFT_ROLES, null,
    ...
    CIC_WEEKLY_HEARING_LIST(NATIONAL, List.of(CFT_IDAM), ALL_VERIFIED_THIRD_PARTY_CFT_ROLES, null,
                            "Criminal Injuries Compensation weekly hearing list", true,
                            false, false, false),
    MAGISTRATES_ADULT_COURT_LIST_DAILY(VENUE, List.of(CRIME_IDAM, PI_AAD), ALL_VERIFIED_THIRD_PARTY_CRIME_ROLES,
                                       null, "Magistrates Adult Court List - Daily",
    ...
    MAGISTRATES_ADULT_COURT_LIST_FUTURE(VENUE, List.of(CRIME_IDAM, PI_AAD), ALL_VERIFIED_THIRD_PARTY_CRIME_ROLES,
                                        ...
                                        true, false, false, false),
    MAGISTRATES_PUBLIC_ADULT_COURT_LIST_DAILY(VENUE, List.of(CRIME_IDAM, PI_AAD), ALL_VERIFIED_THIRD_PARTY_CRIME_ROLES,
                                              null, "Magistrates Public Adult Court List - Daily",
                                              true, false, true, false),
    MAGISTRATES_PUBLIC_ADULT_COURT_LIST_FUTURE(VENUE, List.of(CRIME_IDAM, PI_AAD), ALL_VERIFIED_THIRD_PARTY_CRIME_ROLES,
                                               ...
                                               true, false, false, false),
    CROWN_DAILY_PDDA_LIST(VENUE, List.of(CRIME_IDAM, PI_AAD), ALL_VERIFIED_THIRD_PARTY_CRIME_ROLES, null,
                          "Crown Daily List", true, false, false, false),
    ...
    /**
     * Allowed user provenances for accessing the list.
     */
    private final List<UserProvenances> allowedProvenances;
    ...
    ListType(LocationType listLocationLevel, List<UserProvenances> allowedProvenances,
             List<Roles> allowedThirdPartyRoles) {
