...
public enum ListType {
    ...
    CIVIL_COURTS_RCJ_DAILY_CAUSE_LIST(NATIONAL, List.of(CFT_IDAM), ALL_VERIFIED_THIRD_PARTY_CFT_ROLES,
                                      "Civil Courts at the RCJ Daily Cause List"),
    COURT_OF_APPEAL_CRIMINAL_DAILY_CAUSE_LIST(NATIONAL, List.of(CRIME_IDAM), ALL_VERIFIED_THIRD_PARTY_CRIME_ROLES,
                                              "Court of Appeal (Criminal Division) Daily Cause List"),
    FAMILY_DIVISION_HIGH_COURT_DAILY_CAUSE_LIST(NATIONAL, List.of(CFT_IDAM), ALL_VERIFIED_THIRD_PARTY_CFT_ROLES,
                                                "Family Division of the High Court Daily Cause List"),
    KINGS_BENCH_DIVISION_DAILY_CAUSE_LIST(NATIONAL, List.of(CFT_IDAM), ALL_VERIFIED_THIRD_PARTY_CFT_ROLES,
                                          "King’s Bench Division Daily Cause List"),
    KINGS_BENCH_MASTERS_DAILY_CAUSE_LIST(NATIONAL, List.of(CFT_IDAM), ALL_VERIFIED_THIRD_PARTY_CFT_ROLES,
    ...
    INTELLECTUAL_PROPERTY_LIST_CHD_DAILY_CAUSE_LIST(NATIONAL, List.of(CFT_IDAM), ALL_VERIFIED_THIRD_PARTY_CFT_ROLES,
                                                    ...
                                                    false, false, false, true),
    LONDON_CIRCUIT_COMMERCIAL_COURT_KB_DAILY_CAUSE_LIST(NATIONAL, List.of(CFT_IDAM), ALL_VERIFIED_THIRD_PARTY_CFT_ROLES, null,
    ...
    ADMIRALTY_COURT_KB_DAILY_CAUSE_LIST(
        ...
        null, "Admiralty Court (KB) Daily Cause List",
        false, false, false, true),
    BUSINESS_LIST_CHD_DAILY_CAUSE_LIST(
        NATIONAL, List.of(CFT_IDAM), ALL_VERIFIED_THIRD_PARTY_CFT_ROLES,
        null, "Business List (ChD) Daily Cause List",
        false, false, false, true),
    CHANCERY_APPEALS_CHD_DAILY_CAUSE_LIST(
        NATIONAL, List.of(CFT_IDAM), ALL_VERIFIED_THIRD_PARTY_CFT_ROLES, null, "Chancery Appeals (ChD) Daily Cause List",
        false, false, false, true),
    COMMERCIAL_COURT_KB_DAILY_CAUSE_LIST(
        NATIONAL, List.of(CFT_IDAM), ALL_VERIFIED_THIRD_PARTY_CFT_ROLES, null, "Commercial Court (KB) Daily Cause List",
        false, false, false, true),
    COMPANIES_WINDING_UP_CHD_DAILY_CAUSE_LIST(
        NATIONAL, List.of(CFT_IDAM), ALL_VERIFIED_THIRD_PARTY_CFT_ROLES, null, "Companies Winding Up (ChD) Daily Cause List",
        false, false, false, true),
    ...
    FINANCIAL_LIST_CHD_KB_DAILY_CAUSE_LIST(
        NATIONAL, List.of(CFT_IDAM), ALL_VERIFIED_THIRD_PARTY_CFT_ROLES, null, "Financial List (ChD/KB) Daily Cause List",
        false, false, false, true),
    INSOLVENCY_AND_COMPANIES_COURT_CHD_DAILY_CAUSE_LIST(
        NATIONAL, List.of(CFT_IDAM), ALL_VERIFIED_THIRD_PARTY_CFT_ROLES,
        null, "Insolvency & Companies Court (ChD) Daily Cause List",
        false, false, false, true),
